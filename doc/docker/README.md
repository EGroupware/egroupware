...
## Quick instructions
```
curl https://raw.githubusercontent.com/EGroupware/egroupware/20.1/doc/docker/docker-compose.yml > docker-compose.yml
curl https://raw.githubusercontent.com/EGroupware/egroupware/20.1/doc/docker/nginx.conf > nginx.conf
