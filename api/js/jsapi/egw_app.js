...
var EgwApp = /** @class */ (function () {
    ...
    EgwApp.prototype.add_favorite = function (state) {
        ...
        */
        ...
        jQuery("#" + this.appname + "_favorites_popup_state", this.favorite_popup)
            .replaceWith(jQuery(filter_list.join("")).attr("id", this.appname + "_favorites_popup_state"));
        jQuery("#" + this.appname + "_favorites_popup_state", this.favorite_popup)
            .hide()
    ...
    EgwApp.prototype._create_favorite_popup = function () {
        ...
        this.favorite_popup = jQuery('<div id="' + this.dom_id + '_nm_favorites_popup" title="' + egw().lang("New favorite") + '">\
			...
			</div>').appendTo(this.et2 ? this.et2.getDOMNode() : jQuery('body'));
        // @ts-ignore
