...
export class etemplate2 {
    constructor(_container, _menuaction, _uniqueId) {
     ...
     * @param _response
     */
    static handle_validation_error(_type, _response) {
