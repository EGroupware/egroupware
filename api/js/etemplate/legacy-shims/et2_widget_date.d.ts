...
export declare class et2_date_duration extends Et2DateDuration {}
/** @deprecated use Et2DateDurationReadonly */
export declare class et2_date_duration_ro extends Et2DateDurationReadonly {}
/** @deprecated use Et2DateReadonly */
export declare class et2_date_ro extends Et2DateReadonly {}
/** @deprecated use Et2DateRange */
export declare class et2_date_range extends Et2DateRange {}
