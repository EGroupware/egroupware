...
class Http extends Jmap
{
	 ...
	 * @param string[] $using capability URNs to declare in every call, eg. Api\Mail\Jmap::JMAP_MAIL
	...
	public function call(string $method, array $args) : array
	{
		...
		return $response['methodResponses'][0][1] ?? throw new Api\Exception(__METHOD__.": no response for $method: ".json_encode($response));
	}
