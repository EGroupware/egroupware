        ...
        <form name="login_form" method="post" action="{login_url}">
            <div class="divLoginbox divSideboxEntry">
                ...
                <div>
					...
					<input name="login" tabindex="4" value="{login}" size="30" placeholder="{lang_username}" aria-label="{lang_username}" {autofocus_login}/>
                </div>
                <div>
					<span class="field_icons password"></span>
					<input name="passwd" tabindex="5" value="{passwd}" type="password" size="30" placeholder="{lang_password}" alia-label="{lang_password}"/>
                </div>
				<!-- BEGIN 2fa_section -->
				<div class="{2fa_class}">
					<span class="field_icons password"></span>
					<input name="2fa_code" tabindex="6" size="30" placeholder="{lang_2fa}" aria-label="{lang_2fa}" title="{lang_2fa_help}" aria-description="{lang_2fa_help}"/>
				</div>
				<!-- END 2fa_section -->
               ...
               <!-- END change_password -->
                ...
                <!-- BEGIN registration -->
                <div height="20">
	                <div class="registration">{lostpassword_link}{lostid_link}</div>
	                <div class="registration">{register_link}</div>
                </div>
                <!-- END registration -->
	            <div>
