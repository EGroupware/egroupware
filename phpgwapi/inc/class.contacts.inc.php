	...
	* Inc., 59 Temple Place, Suite 330, Boston, MA  02111-1307  USA            *
	...
	class contacts extends contacts_
	{
		...
		*/
		...
		/*
		* _cmp ($fields, $order, $a, $b)
		*
		* To be used in usort()
		*
		* compares two 2-multidemensional arrays a and b.
		* The first dimension holds the key, that is to be sorted
		* The second dimension holds the data, that's actually compared.
		*
		* There can actually be multiple keys in the array $fields. If the values
		* in the first fields are the same, the second field is compared and so on. This
		* is for subsort.
        	*/
