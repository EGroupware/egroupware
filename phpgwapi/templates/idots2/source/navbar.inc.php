		...
		foreach($GLOBALS['phpgw_info']['navbar'] as $app => $app_data)
		{
			if($app != 'preferences' && $app != 'about' && $app != 'logout')
			{
				...
				if($i<$max_icons)
				{
					...
					$app_icons .= '<td width="200" valign="bottom" align="left"><a href="' . $app_data['url'] . '"';
					...
					$app_icons .= $app_data['target'].'>' . $icon . $title . '</a></td></tr><tr>';
			...
			if($GLOBALS['phpgw_info']['user']['preferences']['common']['start_and_logout_icons']!='no')
			{
				$app_icons .= '<td width="'.$tdwidth.'%" height="32" valign="bottom" align="left"><a href="'.$GLOBALS['phpgw_info']['navbar']['logout']['url'].'"><img src="'.$GLOBALS['phpgw_info']['navbar']['logout']['icon'].'" title="'.$GLOBALS['phpgw_info']['navbar']['logout']['title'].'" alt="'.$GLOBALS['phpgw_info']['navbar']['logout']['title'].'"></a></td>';
