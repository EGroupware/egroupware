...
<td width="1" align="center" valign="middle" class="textSidebox"></td><td class="textSidebox"> &nbsp; <a class="textSidebox" href="{item_link}"{target}>{lang_item}</a></td>
</tr>
<!-- END extra_block_row -->
...
<!-- BEGIN extra_block_row_no_link -->
		<tr class="divSideboxEntry">
<td width="1" align="center" valign="middle" class="textSidebox"></td><td class="textSidebox">{lang_item}</td>
</tr>
