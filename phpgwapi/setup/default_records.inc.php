<?php
  ...
  *  option) any later version.                                              *
  ...
  /* $Id$ */
	...
	$oProc->query("INSERT INTO languages (lang_id, lang_name, available) VALUES ('hu','Hungarian','Yes')");
	...
	$oProc->query("INSERT INTO languages (lang_id, lang_name, available) VALUES ('ja','Japanese','Yes')");
	...
	$oProc->query("INSERT INTO languages (lang_id, lang_name, available) VALUES ('pt','Portuguese','No')");
